...
- [mikkasendke/sessionizer.wezterm](https://github.com/mikkasendke/sessionizer.wezterm?tab=readme-ov-file) - Opening git repositories as their own WezTerm workspaces using `fd`.
